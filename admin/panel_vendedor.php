...
<div class="wrapper">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  <a href="panel_vendedor.php?modulo=&sesion=cerrar" style="margin-left: 50px" >Cerrar Sesion</a>
          ...
          <!-- <a href="#" class="dropdown-item"> -->
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="dropdown-item-title">
                <a href="panel_vendedor.php?modulo=editar_usuario&id=<?php echo $_SESSION['id'];?>" style="margin-left: 47px" >Editar Cuenta</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Vendedor | QualityEggs</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/perfil_vendedor.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="panel_vendedor.php?modulo=dashboard" class="nav-link <?php echo ($modulo=="dashboard"|| $modulo=="")?"active":"";?>">
              ...
              <li class="nav-item">
                <a href="panel_vendedor.php?modulo=ventas" class="nav-link <?php echo ($modulo=="ventas"|| $modulo=="")?"active":"";?>">
