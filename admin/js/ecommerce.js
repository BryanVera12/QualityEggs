...
$(document).ready(function () {
    ...
    function llenaCarrito(response){
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                `
                <a href="panel_2.php?modulo=detalle_producto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
        ...
        $("#listaCarrito").append(
            `
            <a href="panel_2.php?modulo=carrito" class="dropdown-item dropdown-footer text-primary">
                Ver carrito 
