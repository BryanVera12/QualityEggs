...
if (isset($_SESSION['idCliente'])) {
    if(isset($_REQUEST['guardar'])){
        ...
        if($resCli && $resRec){
            echo '<meta http-equiv="refresh" content="0; url=panel_2.php?modulo=pasarela" />';
        }
        else{
        ?>
...
?>
    <form method="post">
        ...
        <a class="btn btn-warning" href="panel_2.php?modulo=carrito" role="button">Regresar al carrito</a>
...
?>
    <div class="mt-5 text-center">
        Debe <a href="login_cliente.php">Ingresar</a> o <a href="registro.php">Registrarse</a>
    </div>
<?php
